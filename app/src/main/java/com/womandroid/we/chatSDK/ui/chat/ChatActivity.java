...
import com.womandroid.we.chatSDK.ui.chat.MessageListAdapter;
import com.womandroid.we.chatSDK.ui.chat.MessageListItem;
import com.womandroid.we.chatSDK.ui.chat.TextInputDelegate;
import com.womandroid.we.chatSDK.ui.chat.TextInputView;
...
public class ChatActivity extends BaseActivity implements TextInputDelegate, ChatOptionsDelegate {
    ...
    protected void initViews () {
        ...
        if (messageListAdapter == null) {
            messageListAdapter = new MessageListAdapter(com.womandroid.we.chatSDK.ui.chat.ChatActivity.this);
        }
    ...
    protected void onResume() {
        ...
        setupTouchUIToDismissKeyboard(findViewById(R.id.chat_sdk_root_view), (v, event) -> {
            ...
            v.postDelayed(() -> {
                if (!scrolling) {
                    hideSoftKeyboard(com.womandroid.we.chatSDK.ui.chat.ChatActivity.this);
                    stopTyping(false);
                }
            }, 300);
        ...
        ChatSDK.ui().setLocalNotificationHandler(thread -> !thread.equals(com.womandroid.we.chatSDK.ui.chat.ChatActivity.this.thread));
    ...
    /**
     * Update chat current thread using the {@link com.womandroid.we.chatSDK.ui.chat.ChatActivity#bundle} bundle saved.
