...
public class FirebaseEventListener implements ChildEventListener, ValueEventListener {
    ...
    public com.womandroid.we.chatSDK.firebase.FirebaseEventListener onChildAdded (Change event) {
        onChildAdded = event;
        return this;
    }

    public com.womandroid.we.chatSDK.firebase.FirebaseEventListener onChildChanged (Change event) {
        onChildChanged = event;
        return this;
    }

    public com.womandroid.we.chatSDK.firebase.FirebaseEventListener onValue(Value event) {
        onValue = event;
        return this;
    }

    public com.womandroid.we.chatSDK.firebase.FirebaseEventListener onChildMoved (Change event) {
        onChildMoved = event;
        return this;
    }

    public com.womandroid.we.chatSDK.firebase.FirebaseEventListener onChildRemoved (Removed event) {
        onChildRemoved = event;
        return this;
    }

    public com.womandroid.we.chatSDK.firebase.FirebaseEventListener onCancelled (Error error) {
        onCancelled = error;
        return this;
    }
