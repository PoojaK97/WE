...
package com.womandroid.we.chatSDK.ui.login;
...
//        PermissionRequestHandler.shared().requestReadExternalStorage(this).subscribe(new CrashReportingCompletableObserver());
    ...
    public void onClick(View v) {
        ...
        Consumer<Throwable> error = throwable -> {
            ...
            Toast.makeText(com.womandroid.we.chatSDK.ui.login.LoginActivity.this, throwable.getLocalizedMessage(), Toast.LENGTH_LONG).show();
        };
